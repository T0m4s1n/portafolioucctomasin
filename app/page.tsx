...
const PortfolioHeader = () => {
    ...
    return (
        <div className="min-h-screen bg-background font-geist p-8 flex justify-center items-center overflow-hidden">
            <div className="relative max-w-2xl w-full mx-auto">
                ...
                >
                    ...
                    >
                        <motion.h1 
                            className="text-6xl font-bold text-green-800 font-roboto"
                        ...
                        <motion.div 
                            className="h-1 w-32 mx-auto mt-4 bg-green-700 rounded-full shadow-md"
                    ...
                    >
                        ...
                        <div className="text-center">
                            <motion.span 
                                className="font-bold text-3xl block text-green-700"
                            ...
                            <motion.span 
                                className="font-medium text-2xl text-green-800 block mt-3"
                                initial={{ opacity: 0, y: 10 }}
                                animate={{ opacity: 1, y: 0 }}
                            ...
                            <motion.p 
                                className="text-gray-600 mt-5 italic text-lg font-roboto"
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                                transition={{ delay: 1 }}
                            >
